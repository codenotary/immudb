...
func (cl *Commandline) setupFlags(cmd *cobra.Command, options *server.Options) {
	...
	cmd.Flags().String("replication-servername", "", "mtls validation servername for replication of systemdb and defaultdb")
	cmd.Flags().Bool("replication-mtls", false, "enable mtls for replication of systemdb and defaultdb")
	cmd.Flags().String("replication-certificate", "", "certifcate filepath for replication of systemdb and defaultdb")
	cmd.Flags().String("replication-pkey", "", "private key filepath for replication of systemdb and defaultdb")
	cmd.Flags().String("replication-clientcas", "", "clients certificates filepath for replication of systemdb and defaultdb")
