...
func (cl *commandline) user(cmd *cobra.Command) {
	ccmd := &cobra.Command{
		...
		Example: `  Create a new user 'username' (password will be generated by the server):
    ...
    ./immuadmin user username --password`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			case create:
				...
				fmt.Printf(
					"User created:\n---\nusername: %s\npassword: %s\n---\n"+
						"IMPORTANT: This is the only time these credentials are shown, so make sure you remember them.\n",
