...
func (cl *commandline) GetImmuClient() client.ImmuClient {
	if cl.immuClient != nil {
		return *cl.immuClient
	}
	c.QuitToStdErr(errors.New("immu client not properly initialized"))
	return nil
}
