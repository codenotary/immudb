...
func (s *InsertDocumentsTestSuite) TestInsertDocumentWithMultipleFields() {
	...
	documentFound := actions.InsertDocumentWithMultipleFields(s.expect, s.sessionID, s.collection, document)
