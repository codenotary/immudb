...
/*
Package authorizationschema is a reverse proxy.
...
func request_AuthorizationService_OpenSessionV2_0(ctx context.Context, marshaler runtime.Marshaler, client AuthorizationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq OpenSessionRequestV2
	...
	msg, err := client.OpenSessionV2(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AuthorizationService_OpenSessionV2_0(ctx context.Context, marshaler runtime.Marshaler, server AuthorizationServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq OpenSessionRequestV2
	var metadata runtime.ServerMetadata
	...
	msg, err := server.OpenSessionV2(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterAuthorizationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuthorizationServiceServer) error {
	...
	mux.Handle("POST", pattern_AuthorizationService_OpenSessionV2_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AuthorizationService_OpenSessionV2_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_AuthorizationService_OpenSessionV2_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAuthorizationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuthorizationServiceClient) error {
	...
	mux.Handle("POST", pattern_AuthorizationService_OpenSessionV2_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthorizationService_OpenSessionV2_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_AuthorizationService_OpenSessionV2_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"authorization", "session", "open"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_AuthorizationService_OpenSessionV2_0 = runtime.ForwardResponseMessage
)
