...
type HealthResponse struct {
	...
	TamperedAt           uint64   `protobuf:"varint,2,opt,name=tamperedAt,proto3" json:"tamperedAt,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *HealthResponse) GetTamperedAt() uint64 {
	if m != nil {
		return m.TamperedAt
	}
	return 0
...
var fileDescriptor_1c5fb4d8cc22d66a = []byte{
	...
	,
}
...
type ImmuServiceClient interface {
	...
	AcknowledgeTampering(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *immuServiceClient) AcknowledgeTampering(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/immudb.schema.ImmuService/AcknowledgeTampering", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ImmuServiceServer interface {
	...
	AcknowledgeTampering(context.Context, *empty.Empty) (*empty.Empty, error)
}
...
func (*UnimplementedImmuServiceServer) AcknowledgeTampering(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AcknowledgeTampering not implemented")
}
...
func _ImmuService_AcknowledgeTampering_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImmuServiceServer).AcknowledgeTampering(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/immudb.schema.ImmuService/AcknowledgeTampering",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImmuServiceServer).AcknowledgeTampering(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ImmuService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AcknowledgeTampering",
			Handler:    _ImmuService_AcknowledgeTampering_Handler,
		},
	},
