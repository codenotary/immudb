...
var file_schema_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x61, 0x64, 0x57, 0x72, 0x69, 0x74, 0x65, 0x10, 0x02, 0x32, 0xe8, 0x33, 0x0a, 0x0b,
	...
	0x71, 0x6c, 0x67, 0x65, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x7c, 0x0a, 0x10, 0x54, 0x72, 0x75, 0x6e,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x11, 0x22, 0x0c, 0x2f, 0x64, 0x62, 0x2f, 0x74, 0x72, 0x75, 0x6e, 0x63,
	0x61, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x42, 0x8b, 0x03, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_schema_proto_depIdxs = []int32{
	...
	108, // 209: immudb.schema.ImmuService.SQLExec:input_type -> immudb.schema.SQLExecRequest
	109, // 210: immudb.schema.ImmuService.SQLQuery:input_type -> immudb.schema.SQLQueryRequest
	134, // 211: immudb.schema.ImmuService.ListTables:input_type -> google.protobuf.Empty
	94,  // 212: immudb.schema.ImmuService.DescribeTable:input_type -> immudb.schema.Table
	96,  // 213: immudb.schema.ImmuService.VerifiableSQLGet:input_type -> immudb.schema.VerifiableSQLGetRequest
	122, // 214: immudb.schema.ImmuService.TruncateDatabase:input_type -> immudb.schema.TruncateDatabaseRequest
	6,   // 215: immudb.schema.ImmuService.ListUsers:output_type -> immudb.schema.UserList
	134, // 216: immudb.schema.ImmuService.CreateUser:output_type -> google.protobuf.Empty
	134, // 217: immudb.schema.ImmuService.ChangePassword:output_type -> google.protobuf.Empty
	134, // 218: immudb.schema.ImmuService.ChangePermission:output_type -> google.protobuf.Empty
	134, // 219: immudb.schema.ImmuService.SetActiveUser:output_type -> google.protobuf.Empty
	134, // 220: immudb.schema.ImmuService.UpdateAuthConfig:output_type -> google.protobuf.Empty
	134, // 221: immudb.schema.ImmuService.UpdateMTLSConfig:output_type -> google.protobuf.Empty
	15,  // 222: immudb.schema.ImmuService.OpenSession:output_type -> immudb.schema.OpenSessionResponse
	134, // 223: immudb.schema.ImmuService.CloseSession:output_type -> google.protobuf.Empty
	134, // 224: immudb.schema.ImmuService.KeepAlive:output_type -> google.protobuf.Empty
	118, // 225: immudb.schema.ImmuService.NewTx:output_type -> immudb.schema.NewTxResponse
	112, // 226: immudb.schema.ImmuService.Commit:output_type -> immudb.schema.CommittedSQLTx
	134, // 227: immudb.schema.ImmuService.Rollback:output_type -> google.protobuf.Empty
	134, // 228: immudb.schema.ImmuService.TxSQLExec:output_type -> google.protobuf.Empty
	113, // 229: immudb.schema.ImmuService.TxSQLQuery:output_type -> immudb.schema.SQLQueryResult
	11,  // 230: immudb.schema.ImmuService.Login:output_type -> immudb.schema.LoginResponse
	134, // 231: immudb.schema.ImmuService.Logout:output_type -> google.protobuf.Empty
	29,  // 232: immudb.schema.ImmuService.Set:output_type -> immudb.schema.TxHeader
	38,  // 233: immudb.schema.ImmuService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	18,  // 234: immudb.schema.ImmuService.Get:output_type -> immudb.schema.Entry
	39,  // 235: immudb.schema.ImmuService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	29,  // 236: immudb.schema.ImmuService.Delete:output_type -> immudb.schema.TxHeader
	22,  // 237: immudb.schema.ImmuService.GetAll:output_type -> immudb.schema.Entries
	29,  // 238: immudb.schema.ImmuService.ExecAll:output_type -> immudb.schema.TxHeader
	22,  // 239: immudb.schema.ImmuService.Scan:output_type -> immudb.schema.Entries
	27,  // 240: immudb.schema.ImmuService.Count:output_type -> immudb.schema.EntryCount
	27,  // 241: immudb.schema.ImmuService.CountAll:output_type -> immudb.schema.EntryCount
	34,  // 242: immudb.schema.ImmuService.TxById:output_type -> immudb.schema.Tx
	38,  // 243: immudb.schema.ImmuService.VerifiableTxById:output_type -> immudb.schema.VerifiableTx
	64,  // 244: immudb.schema.ImmuService.TxScan:output_type -> immudb.schema.TxList
	22,  // 245: immudb.schema.ImmuService.History:output_type -> immudb.schema.Entries
	48,  // 246: immudb.schema.ImmuService.ServerInfo:output_type -> immudb.schema.ServerInfoResponse
	49,  // 247: immudb.schema.ImmuService.Health:output_type -> immudb.schema.HealthResponse
	50,  // 248: immudb.schema.ImmuService.DatabaseHealth:output_type -> immudb.schema.DatabaseHealthResponse
	51,  // 249: immudb.schema.ImmuService.CurrentState:output_type -> immudb.schema.ImmutableState
	29,  // 250: immudb.schema.ImmuService.SetReference:output_type -> immudb.schema.TxHeader
	38,  // 251: immudb.schema.ImmuService.VerifiableSetReference:output_type -> immudb.schema.VerifiableTx
	29,  // 252: immudb.schema.ImmuService.ZAdd:output_type -> immudb.schema.TxHeader
	38,  // 253: immudb.schema.ImmuService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	24,  // 254: immudb.schema.ImmuService.ZScan:output_type -> immudb.schema.ZEntries
	134, // 255: immudb.schema.ImmuService.CreateDatabase:output_type -> google.protobuf.Empty
	134, // 256: immudb.schema.ImmuService.CreateDatabaseWith:output_type -> google.protobuf.Empty
	70,  // 257: immudb.schema.ImmuService.CreateDatabaseV2:output_type -> immudb.schema.CreateDatabaseResponse
	87,  // 258: immudb.schema.ImmuService.LoadDatabase:output_type -> immudb.schema.LoadDatabaseResponse
	89,  // 259: immudb.schema.ImmuService.UnloadDatabase:output_type -> immudb.schema.UnloadDatabaseResponse
	91,  // 260: immudb.schema.ImmuService.DeleteDatabase:output_type -> immudb.schema.DeleteDatabaseResponse
	102, // 261: immudb.schema.ImmuService.DatabaseList:output_type -> immudb.schema.DatabaseListResponse
	104, // 262: immudb.schema.ImmuService.DatabaseListV2:output_type -> immudb.schema.DatabaseListResponseV2
	99,  // 263: immudb.schema.ImmuService.UseDatabase:output_type -> immudb.schema.UseDatabaseReply
	134, // 264: immudb.schema.ImmuService.UpdateDatabase:output_type -> google.protobuf.Empty
	72,  // 265: immudb.schema.ImmuService.UpdateDatabaseV2:output_type -> immudb.schema.UpdateDatabaseResponse
	68,  // 266: immudb.schema.ImmuService.GetDatabaseSettings:output_type -> immudb.schema.DatabaseSettings
	74,  // 267: immudb.schema.ImmuService.GetDatabaseSettingsV2:output_type -> immudb.schema.DatabaseSettingsResponse
	93,  // 268: immudb.schema.ImmuService.FlushIndex:output_type -> immudb.schema.FlushIndexResponse
	134, // 269: immudb.schema.ImmuService.CompactIndex:output_type -> google.protobuf.Empty
	106, // 270: immudb.schema.ImmuService.streamGet:output_type -> immudb.schema.Chunk
	29,  // 271: immudb.schema.ImmuService.streamSet:output_type -> immudb.schema.TxHeader
	106, // 272: immudb.schema.ImmuService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	38,  // 273: immudb.schema.ImmuService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	106, // 274: immudb.schema.ImmuService.streamScan:output_type -> immudb.schema.Chunk
	106, // 275: immudb.schema.ImmuService.streamZScan:output_type -> immudb.schema.Chunk
	106, // 276: immudb.schema.ImmuService.streamHistory:output_type -> immudb.schema.Chunk
	29,  // 277: immudb.schema.ImmuService.streamExecAll:output_type -> immudb.schema.TxHeader
	106, // 278: immudb.schema.ImmuService.exportTx:output_type -> immudb.schema.Chunk
	29,  // 279: immudb.schema.ImmuService.replicateTx:output_type -> immudb.schema.TxHeader
	111, // 280: immudb.schema.ImmuService.SQLExec:output_type -> immudb.schema.SQLExecResult
	113, // 281: immudb.schema.ImmuService.SQLQuery:output_type -> immudb.schema.SQLQueryResult
	113, // 282: immudb.schema.ImmuService.ListTables:output_type -> immudb.schema.SQLQueryResult
	113, // 283: immudb.schema.ImmuService.DescribeTable:output_type -> immudb.schema.SQLQueryResult
	98,  // 284: immudb.schema.ImmuService.VerifiableSQLGet:output_type -> immudb.schema.VerifiableSQLEntry
	123, // 285: immudb.schema.ImmuService.TruncateDatabase:output_type -> immudb.schema.TruncateDatabaseResponse
	215, // [215:286] is the sub-list for method output_type
	144, // [144:215] is the sub-list for method input_type
