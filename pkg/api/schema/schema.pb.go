...
type AtomicOperation struct {
	...
	//	*AtomicOperation_KVs
	//	*AtomicOperation_ZOpts
	Operation            isAtomicOperation_Operation `protobuf_oneof:"operation"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}

func (m *AtomicOperation) Reset()         { *m = AtomicOperation{} }
func (m *AtomicOperation) String() string { return proto.CompactTextString(m) }
func (*AtomicOperation) ProtoMessage()    {}
func (*AtomicOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c5fb4d8cc22d66a, []int{15}
}

func (m *AtomicOperation) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AtomicOperation.Unmarshal(m, b)
}
func (m *AtomicOperation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AtomicOperation.Marshal(b, m, deterministic)
}
func (m *AtomicOperation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AtomicOperation.Merge(m, src)
}
func (m *AtomicOperation) XXX_Size() int {
	return xxx_messageInfo_AtomicOperation.Size(m)
}
func (m *AtomicOperation) XXX_DiscardUnknown() {
	xxx_messageInfo_AtomicOperation.DiscardUnknown(m)
}

var xxx_messageInfo_AtomicOperation proto.InternalMessageInfo

type isAtomicOperation_Operation interface {
	isAtomicOperation_Operation()
}

type AtomicOperation_KVs struct {
	KVs *KeyValue `protobuf:"bytes,1,opt,name=KVs,proto3,oneof"`
}

type AtomicOperation_ZOpts struct {
	ZOpts *ZAddOptions `protobuf:"bytes,2,opt,name=ZOpts,proto3,oneof"`
}

func (*AtomicOperation_KVs) isAtomicOperation_Operation() {}

func (*AtomicOperation_ZOpts) isAtomicOperation_Operation() {}

func (m *AtomicOperation) GetOperation() isAtomicOperation_Operation {
	if m != nil {
		return m.Operation
	}
	return nil
...
func (m *AtomicOperation) GetKVs() *KeyValue {
	if x, ok := m.GetOperation().(*AtomicOperation_KVs); ok {
		return x.KVs
	}
	return nil
}

func (m *AtomicOperation) GetZOpts() *ZAddOptions {
	if x, ok := m.GetOperation().(*AtomicOperation_ZOpts); ok {
		return x.ZOpts
	}
	return nil
}
...
func (*AtomicOperation) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*AtomicOperation_KVs)(nil),
		(*AtomicOperation_ZOpts)(nil),
	}
}

type AtomicOperations struct {
	Operations           []*AtomicOperation `protobuf:"bytes,1,rep,name=Operations,proto3" json:"Operations,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}

func (m *AtomicOperations) Reset()         { *m = AtomicOperations{} }
func (m *AtomicOperations) String() string { return proto.CompactTextString(m) }
func (*AtomicOperations) ProtoMessage()    {}
func (*AtomicOperations) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c5fb4d8cc22d66a, []int{16}
}

func (m *AtomicOperations) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AtomicOperations.Unmarshal(m, b)
}
func (m *AtomicOperations) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AtomicOperations.Marshal(b, m, deterministic)
}
func (m *AtomicOperations) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AtomicOperations.Merge(m, src)
}
func (m *AtomicOperations) XXX_Size() int {
	return xxx_messageInfo_AtomicOperations.Size(m)
}
func (m *AtomicOperations) XXX_DiscardUnknown() {
	xxx_messageInfo_AtomicOperations.DiscardUnknown(m)
}

var xxx_messageInfo_AtomicOperations proto.InternalMessageInfo

func (m *AtomicOperations) GetOperations() []*AtomicOperation {
	if m != nil {
		return m.Operations
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*AtomicOperation)(nil), "immudb.schema.AtomicOperation")
	proto.RegisterType((*AtomicOperations)(nil), "immudb.schema.AtomicOperations")
...
var fileDescriptor_1c5fb4d8cc22d66a = []byte{
	...
	,
}
...
type ImmuServiceClient interface {
	...
	SetBatchAtomicOperations(ctx context.Context, in *AtomicOperations, opts ...grpc.CallOption) (*Index, error)
...
func (c *immuServiceClient) SetBatchAtomicOperations(ctx context.Context, in *AtomicOperations, opts ...grpc.CallOption) (*Index, error) {
	out := new(Index)
	err := c.cc.Invoke(ctx, "/immudb.schema.ImmuService/SetBatchAtomicOperations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ImmuServiceServer interface {
	...
	SetBatchAtomicOperations(context.Context, *AtomicOperations) (*Index, error)
...
func (*UnimplementedImmuServiceServer) SetBatchAtomicOperations(ctx context.Context, req *AtomicOperations) (*Index, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetBatchAtomicOperations not implemented")
}
...
func _ImmuService_SetBatchAtomicOperations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AtomicOperations)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImmuServiceServer).SetBatchAtomicOperations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/immudb.schema.ImmuService/SetBatchAtomicOperations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImmuServiceServer).SetBatchAtomicOperations(ctx, req.(*AtomicOperations))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ImmuService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetBatchAtomicOperations",
			Handler:    _ImmuService_SetBatchAtomicOperations_Handler,
		},
		{
			MethodName: "Scan",
