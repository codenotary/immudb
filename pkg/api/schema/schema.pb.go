...
var file_schema_proto_rawDesc = []byte{
	...
	0x4b, 0x45, 0x10, 0x01, 0x32, 0x85, 0x25, 0x0a, 0x0b, 0x49, 0x6d, 0x6d, 0x75, 0x53, 0x65, 0x72,
	...
	0x62, 0x2f, 0x67, 0x65, 0x74, 0x61, 0x6c, 0x6c, 0x3a, 0x01, 0x2a, 0x12, 0x61, 0x0a, 0x09, 0x44,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x41, 0x6c, 0x6c, 0x12, 0x20, 0x2e, 0x69, 0x6d, 0x6d, 0x75, 0x64,
	...
	0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x54, 0x78, 0x48, 0x65, 0x61,
	0x64, 0x65, 0x72, 0x22, 0x19, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x13, 0x22, 0x0e, 0x2f, 0x64, 0x62,
	0x2f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x6b, 0x65, 0x79, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x59,
...
var file_schema_proto_depIdxs = []int32{
	...
	36,  // 69: immudb.schema.ImmuService.GetAll:input_type -> immudb.schema.KeyListRequest
	37,  // 70: immudb.schema.ImmuService.DeleteAll:input_type -> immudb.schema.DeleteKeysRequest
	...
	24,  // 122: immudb.schema.ImmuService.DeleteAll:output_type -> immudb.schema.TxHeader
...
type ImmuServiceClient interface {
	...
	DeleteAll(ctx context.Context, in *DeleteKeysRequest, opts ...grpc.CallOption) (*TxHeader, error)
...
func (c *immuServiceClient) DeleteAll(ctx context.Context, in *DeleteKeysRequest, opts ...grpc.CallOption) (*TxHeader, error) {
	out := new(TxHeader)
	err := c.cc.Invoke(ctx, "/immudb.schema.ImmuService/DeleteAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ImmuServiceServer interface {
	...
	DeleteAll(context.Context, *DeleteKeysRequest) (*TxHeader, error)
...
func (*UnimplementedImmuServiceServer) DeleteAll(context.Context, *DeleteKeysRequest) (*TxHeader, error) {
...
func _ImmuService_DeleteAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteKeysRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImmuServiceServer).DeleteAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/immudb.schema.ImmuService/DeleteAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImmuServiceServer).DeleteAll(ctx, req.(*DeleteKeysRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ImmuService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ImmuService_DeleteAll_Handler,
		},
		{
			MethodName: "ExecAll",
