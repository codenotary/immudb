...
var file_schema_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x65, 0x61, 0x64, 0x57, 0x72, 0x69, 0x74, 0x65, 0x10, 0x02, 0x32, 0xdc, 0x28, 0x0a,
	...
	0x2f, 0x64, 0x62, 0x2f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x58, 0x0a,
...
var file_schema_proto_depIdxs = []int32{
	...
	92,  // 104: immudb.schema.ImmuService.CompactIndex:input_type -> google.protobuf.Empty
	66,  // 105: immudb.schema.ImmuService.ChangePermission:input_type -> immudb.schema.ChangePermissionRequest
	67,  // 106: immudb.schema.ImmuService.SetActiveUser:input_type -> immudb.schema.SetActiveUserRequest
	39,  // 107: immudb.schema.ImmuService.streamGet:input_type -> immudb.schema.KeyRequest
	69,  // 108: immudb.schema.ImmuService.streamSet:input_type -> immudb.schema.Chunk
	43,  // 109: immudb.schema.ImmuService.streamVerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	69,  // 110: immudb.schema.ImmuService.streamVerifiableSet:input_type -> immudb.schema.Chunk
	23,  // 111: immudb.schema.ImmuService.streamScan:input_type -> immudb.schema.ScanRequest
	50,  // 112: immudb.schema.ImmuService.streamZScan:input_type -> immudb.schema.ZScanRequest
	51,  // 113: immudb.schema.ImmuService.streamHistory:input_type -> immudb.schema.HistoryRequest
	69,  // 114: immudb.schema.ImmuService.streamExecAll:input_type -> immudb.schema.Chunk
	53,  // 115: immudb.schema.ImmuService.exportTx:input_type -> immudb.schema.TxRequest
	69,  // 116: immudb.schema.ImmuService.replicateTx:input_type -> immudb.schema.Chunk
	71,  // 117: immudb.schema.ImmuService.SQLExec:input_type -> immudb.schema.SQLExecRequest
	72,  // 118: immudb.schema.ImmuService.SQLQuery:input_type -> immudb.schema.SQLQueryRequest
	92,  // 119: immudb.schema.ImmuService.ListTables:input_type -> google.protobuf.Empty
	60,  // 120: immudb.schema.ImmuService.DescribeTable:input_type -> immudb.schema.Table
	62,  // 121: immudb.schema.ImmuService.VerifiableSQLGet:input_type -> immudb.schema.VerifiableSQLGetRequest
	5,   // 122: immudb.schema.ImmuService.ListUsers:output_type -> immudb.schema.UserList
	92,  // 123: immudb.schema.ImmuService.CreateUser:output_type -> google.protobuf.Empty
	92,  // 124: immudb.schema.ImmuService.ChangePassword:output_type -> google.protobuf.Empty
	92,  // 125: immudb.schema.ImmuService.UpdateAuthConfig:output_type -> google.protobuf.Empty
	92,  // 126: immudb.schema.ImmuService.UpdateMTLSConfig:output_type -> google.protobuf.Empty
	14,  // 127: immudb.schema.ImmuService.OpenSession:output_type -> immudb.schema.OpenSessionResponse
	92,  // 128: immudb.schema.ImmuService.CloseSession:output_type -> google.protobuf.Empty
	92,  // 129: immudb.schema.ImmuService.KeepAlive:output_type -> google.protobuf.Empty
	81,  // 130: immudb.schema.ImmuService.NewTx:output_type -> immudb.schema.NewTxResponse
	75,  // 131: immudb.schema.ImmuService.Commit:output_type -> immudb.schema.CommittedSQLTx
	92,  // 132: immudb.schema.ImmuService.Rollback:output_type -> google.protobuf.Empty
	92,  // 133: immudb.schema.ImmuService.TxSQLExec:output_type -> google.protobuf.Empty
	76,  // 134: immudb.schema.ImmuService.TxSQLQuery:output_type -> immudb.schema.SQLQueryResult
	10,  // 135: immudb.schema.ImmuService.Login:output_type -> immudb.schema.LoginResponse
	92,  // 136: immudb.schema.ImmuService.Logout:output_type -> google.protobuf.Empty
	27,  // 137: immudb.schema.ImmuService.Set:output_type -> immudb.schema.TxHeader
	35,  // 138: immudb.schema.ImmuService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	16,  // 139: immudb.schema.ImmuService.Get:output_type -> immudb.schema.Entry
	36,  // 140: immudb.schema.ImmuService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	27,  // 141: immudb.schema.ImmuService.Delete:output_type -> immudb.schema.TxHeader
	20,  // 142: immudb.schema.ImmuService.GetAll:output_type -> immudb.schema.Entries
	27,  // 143: immudb.schema.ImmuService.ExecAll:output_type -> immudb.schema.TxHeader
	20,  // 144: immudb.schema.ImmuService.Scan:output_type -> immudb.schema.Entries
	25,  // 145: immudb.schema.ImmuService.Count:output_type -> immudb.schema.EntryCount
	25,  // 146: immudb.schema.ImmuService.CountAll:output_type -> immudb.schema.EntryCount
	31,  // 147: immudb.schema.ImmuService.TxById:output_type -> immudb.schema.Tx
	35,  // 148: immudb.schema.ImmuService.VerifiableTxById:output_type -> immudb.schema.VerifiableTx
	56,  // 149: immudb.schema.ImmuService.TxScan:output_type -> immudb.schema.TxList
	20,  // 150: immudb.schema.ImmuService.History:output_type -> immudb.schema.Entries
	44,  // 151: immudb.schema.ImmuService.Health:output_type -> immudb.schema.HealthResponse
	45,  // 152: immudb.schema.ImmuService.CurrentState:output_type -> immudb.schema.ImmutableState
	27,  // 153: immudb.schema.ImmuService.SetReference:output_type -> immudb.schema.TxHeader
	35,  // 154: immudb.schema.ImmuService.VerifiableSetReference:output_type -> immudb.schema.VerifiableTx
	27,  // 155: immudb.schema.ImmuService.ZAdd:output_type -> immudb.schema.TxHeader
	35,  // 156: immudb.schema.ImmuService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	22,  // 157: immudb.schema.ImmuService.ZScan:output_type -> immudb.schema.ZEntries
	92,  // 158: immudb.schema.ImmuService.CreateDatabase:output_type -> google.protobuf.Empty
	92,  // 159: immudb.schema.ImmuService.CreateDatabaseWith:output_type -> google.protobuf.Empty
	68,  // 160: immudb.schema.ImmuService.DatabaseList:output_type -> immudb.schema.DatabaseListResponse
	65,  // 161: immudb.schema.ImmuService.UseDatabase:output_type -> immudb.schema.UseDatabaseReply
	92,  // 162: immudb.schema.ImmuService.UpdateDatabase:output_type -> google.protobuf.Empty
	92,  // 163: immudb.schema.ImmuService.CompactIndex:output_type -> google.protobuf.Empty
	92,  // 164: immudb.schema.ImmuService.ChangePermission:output_type -> google.protobuf.Empty
	92,  // 165: immudb.schema.ImmuService.SetActiveUser:output_type -> google.protobuf.Empty
	69,  // 166: immudb.schema.ImmuService.streamGet:output_type -> immudb.schema.Chunk
	27,  // 167: immudb.schema.ImmuService.streamSet:output_type -> immudb.schema.TxHeader
	69,  // 168: immudb.schema.ImmuService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	35,  // 169: immudb.schema.ImmuService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	69,  // 170: immudb.schema.ImmuService.streamScan:output_type -> immudb.schema.Chunk
	69,  // 171: immudb.schema.ImmuService.streamZScan:output_type -> immudb.schema.Chunk
	69,  // 172: immudb.schema.ImmuService.streamHistory:output_type -> immudb.schema.Chunk
	27,  // 173: immudb.schema.ImmuService.streamExecAll:output_type -> immudb.schema.TxHeader
	69,  // 174: immudb.schema.ImmuService.exportTx:output_type -> immudb.schema.Chunk
	27,  // 175: immudb.schema.ImmuService.replicateTx:output_type -> immudb.schema.TxHeader
	74,  // 176: immudb.schema.ImmuService.SQLExec:output_type -> immudb.schema.SQLExecResult
	76,  // 177: immudb.schema.ImmuService.SQLQuery:output_type -> immudb.schema.SQLQueryResult
	76,  // 178: immudb.schema.ImmuService.ListTables:output_type -> immudb.schema.SQLQueryResult
	76,  // 179: immudb.schema.ImmuService.DescribeTable:output_type -> immudb.schema.SQLQueryResult
	64,  // 180: immudb.schema.ImmuService.VerifiableSQLGet:output_type -> immudb.schema.VerifiableSQLEntry
