...
type Proofs struct {
	Inclusion            *InclusionProof   `protobuf:"bytes,1,opt,name=inclusion,proto3" json:"inclusion,omitempty"`
	Consistency          *ConsistencyProof `protobuf:"bytes,2,opt,name=consistency,proto3" json:"consistency,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *Proofs) GetInclusion() *InclusionProof {
	if m != nil {
		return m.Inclusion
	}
	return nil
...
func (m *Proofs) GetConsistency() *ConsistencyProof {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Proofs)(nil), "immudb.schema.Proofs")
...
var fileDescriptor_1c5fb4d8cc22d66a = []byte{
	...
	,
}
...
type ImmuServiceClient interface {
	...
	SafeSet(ctx context.Context, in *SafeSetOptions, opts ...grpc.CallOption) (*Proofs, error)
...
func (c *immuServiceClient) SafeSet(ctx context.Context, in *SafeSetOptions, opts ...grpc.CallOption) (*Proofs, error) {
	out := new(Proofs)
...
type ImmuServiceServer interface {
	...
	SafeSet(context.Context, *SafeSetOptions) (*Proofs, error)
...
func (*UnimplementedImmuServiceServer) SafeSet(ctx context.Context, req *SafeSetOptions) (*Proofs, error) {
