...
var file_schema_proto_rawDesc = []byte{
	...
	0x52, 0x45, 0x56, 0x4f, 0x4b, 0x45, 0x10, 0x01, 0x32, 0xa6, 0x1c, 0x0a, 0x0b, 0x49, 0x6d, 0x6d,
	...
	0x65, 0x72, 0x3a, 0x01, 0x2a, 0x12, 0x3a, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12,
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x22, 0x00, 0x28, 0x01, 0x30,
	0x01, 0x42, 0x8b, 0x03, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var file_schema_proto_depIdxs = []int32{
	...
	53, // 63: immudb.schema.ImmuService.Stream:input_type -> immudb.schema.Chunk
	4,  // 64: immudb.schema.ImmuService.ListUsers:output_type -> immudb.schema.UserList
	54, // 65: immudb.schema.ImmuService.CreateUser:output_type -> google.protobuf.Empty
	54, // 66: immudb.schema.ImmuService.ChangePassword:output_type -> google.protobuf.Empty
	54, // 67: immudb.schema.ImmuService.UpdateAuthConfig:output_type -> google.protobuf.Empty
	54, // 68: immudb.schema.ImmuService.UpdateMTLSConfig:output_type -> google.protobuf.Empty
	9,  // 69: immudb.schema.ImmuService.Login:output_type -> immudb.schema.LoginResponse
	54, // 70: immudb.schema.ImmuService.Logout:output_type -> google.protobuf.Empty
	24, // 71: immudb.schema.ImmuService.Set:output_type -> immudb.schema.TxMetadata
	29, // 72: immudb.schema.ImmuService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	13, // 73: immudb.schema.ImmuService.Get:output_type -> immudb.schema.Entry
	30, // 74: immudb.schema.ImmuService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	17, // 75: immudb.schema.ImmuService.GetAll:output_type -> immudb.schema.Entries
	24, // 76: immudb.schema.ImmuService.ExecAll:output_type -> immudb.schema.TxMetadata
	17, // 77: immudb.schema.ImmuService.Scan:output_type -> immudb.schema.Entries
	22, // 78: immudb.schema.ImmuService.Count:output_type -> immudb.schema.EntryCount
	22, // 79: immudb.schema.ImmuService.CountAll:output_type -> immudb.schema.EntryCount
	27, // 80: immudb.schema.ImmuService.TxById:output_type -> immudb.schema.Tx
	29, // 81: immudb.schema.ImmuService.VerifiableTxById:output_type -> immudb.schema.VerifiableTx
	17, // 82: immudb.schema.ImmuService.History:output_type -> immudb.schema.Entries
	37, // 83: immudb.schema.ImmuService.Health:output_type -> immudb.schema.HealthResponse
	38, // 84: immudb.schema.ImmuService.CurrentState:output_type -> immudb.schema.ImmutableState
	24, // 85: immudb.schema.ImmuService.SetReference:output_type -> immudb.schema.TxMetadata
	29, // 86: immudb.schema.ImmuService.VerifiableSetReference:output_type -> immudb.schema.VerifiableTx
	24, // 87: immudb.schema.ImmuService.ZAdd:output_type -> immudb.schema.TxMetadata
	29, // 88: immudb.schema.ImmuService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	19, // 89: immudb.schema.ImmuService.ZScan:output_type -> immudb.schema.ZEntries
	54, // 90: immudb.schema.ImmuService.CreateDatabase:output_type -> google.protobuf.Empty
	52, // 91: immudb.schema.ImmuService.DatabaseList:output_type -> immudb.schema.DatabaseListResponse
	49, // 92: immudb.schema.ImmuService.UseDatabase:output_type -> immudb.schema.UseDatabaseReply
	54, // 93: immudb.schema.ImmuService.CleanIndex:output_type -> google.protobuf.Empty
	54, // 94: immudb.schema.ImmuService.ChangePermission:output_type -> google.protobuf.Empty
	54, // 95: immudb.schema.ImmuService.SetActiveUser:output_type -> google.protobuf.Empty
	53, // 96: immudb.schema.ImmuService.Stream:output_type -> immudb.schema.Chunk
...
type ImmuServiceClient interface {
	...
	// Streams
	Stream(ctx context.Context, opts ...grpc.CallOption) (ImmuService_StreamClient, error)
}
...
func (c *immuServiceClient) Stream(ctx context.Context, opts ...grpc.CallOption) (ImmuService_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ImmuService_serviceDesc.Streams[0], "/immudb.schema.ImmuService/Stream", opts...)
	if err != nil {
		return nil, err
	}
	x := &immuServiceStreamClient{stream}
	return x, nil
}

type ImmuService_StreamClient interface {
	Send(*Chunk) error
	Recv() (*Chunk, error)
	grpc.ClientStream
}

type immuServiceStreamClient struct {
	grpc.ClientStream
}

func (x *immuServiceStreamClient) Send(m *Chunk) error {
	return x.ClientStream.SendMsg(m)
}

func (x *immuServiceStreamClient) Recv() (*Chunk, error) {
	m := new(Chunk)
...
type ImmuServiceServer interface {
	...
	// Streams
	Stream(ImmuService_StreamServer) error
}
...
func (*UnimplementedImmuServiceServer) Stream(ImmuService_StreamServer) error {
...
func _ImmuService_Stream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ImmuServiceServer).Stream(&immuServiceStreamServer{stream})
}

type ImmuService_StreamServer interface {
	Send(*Chunk) error
	Recv() (*Chunk, error)
	grpc.ServerStream
}

type immuServiceStreamServer struct {
	grpc.ServerStream
}

func (x *immuServiceStreamServer) Send(m *Chunk) error {
	return x.ServerStream.SendMsg(m)
}

func (x *immuServiceStreamServer) Recv() (*Chunk, error) {
	m := new(Chunk)
...
var _ImmuService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Stream",
			Handler:       _ImmuService_Stream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
