...
var file_schema_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xd1, 0x01, 0x0a, 0x12, 0x56, 0x65, 0x72,
	...
	0x63, 0x6c, 0x75, 0x73, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0x28, 0x0a, 0x10,
	...
	0x6d, 0x0a, 0x0d, 0x53, 0x51, 0x4c, 0x45, 0x78, 0x65, 0x63, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	...
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x74, 0x78, 0x73, 0x22, 0x69,
	...
	0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2a, 0x29, 0x0a, 0x10, 0x50, 0x65, 0x72, 0x6d, 0x69,
...
var file_schema_proto_msgTypes = make([]protoimpl.MessageInfo, 69)
...
var file_schema_proto_depIdxs = []int32{
	...
	0,  // 35: immudb.schema.ChangePermissionRequest.action:type_name -> immudb.schema.PermissionAction
	50, // 36: immudb.schema.DatabaseListResponse.databases:type_name -> immudb.schema.Database
	64, // 37: immudb.schema.SQLExecRequest.params:type_name -> immudb.schema.NamedParam
	64, // 38: immudb.schema.SQLQueryRequest.params:type_name -> immudb.schema.NamedParam
	69, // 39: immudb.schema.NamedParam.value:type_name -> immudb.schema.SQLValue
	24, // 40: immudb.schema.SQLExecResult.ctxs:type_name -> immudb.schema.TxMetadata
	24, // 41: immudb.schema.SQLExecResult.dtxs:type_name -> immudb.schema.TxMetadata
	67, // 42: immudb.schema.SQLQueryResult.columns:type_name -> immudb.schema.Column
	68, // 43: immudb.schema.SQLQueryResult.rows:type_name -> immudb.schema.Row
	69, // 44: immudb.schema.Row.values:type_name -> immudb.schema.SQLValue
	70, // 45: immudb.schema.SQLValue.null:type_name -> google.protobuf.NullValue
	71, // 46: immudb.schema.ImmuService.ListUsers:input_type -> google.protobuf.Empty
	5,  // 47: immudb.schema.ImmuService.CreateUser:input_type -> immudb.schema.CreateUserRequest
	7,  // 48: immudb.schema.ImmuService.ChangePassword:input_type -> immudb.schema.ChangePasswordRequest
	10, // 49: immudb.schema.ImmuService.UpdateAuthConfig:input_type -> immudb.schema.AuthConfig
	11, // 50: immudb.schema.ImmuService.UpdateMTLSConfig:input_type -> immudb.schema.MTLSConfig
	8,  // 51: immudb.schema.ImmuService.Login:input_type -> immudb.schema.LoginRequest
	71, // 52: immudb.schema.ImmuService.Logout:input_type -> google.protobuf.Empty
	32, // 53: immudb.schema.ImmuService.Set:input_type -> immudb.schema.SetRequest
	35, // 54: immudb.schema.ImmuService.VerifiableSet:input_type -> immudb.schema.VerifiableSetRequest
	33, // 55: immudb.schema.ImmuService.Get:input_type -> immudb.schema.KeyRequest
	36, // 56: immudb.schema.ImmuService.VerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	34, // 57: immudb.schema.ImmuService.GetAll:input_type -> immudb.schema.KeyListRequest
	16, // 58: immudb.schema.ImmuService.ExecAll:input_type -> immudb.schema.ExecAllRequest
	20, // 59: immudb.schema.ImmuService.Scan:input_type -> immudb.schema.ScanRequest
	21, // 60: immudb.schema.ImmuService.Count:input_type -> immudb.schema.KeyPrefix
	71, // 61: immudb.schema.ImmuService.CountAll:input_type -> google.protobuf.Empty
	46, // 62: immudb.schema.ImmuService.TxById:input_type -> immudb.schema.TxRequest
	47, // 63: immudb.schema.ImmuService.VerifiableTxById:input_type -> immudb.schema.VerifiableTxRequest
	48, // 64: immudb.schema.ImmuService.TxScan:input_type -> immudb.schema.TxScanRequest
	44, // 65: immudb.schema.ImmuService.History:input_type -> immudb.schema.HistoryRequest
	71, // 66: immudb.schema.ImmuService.Health:input_type -> google.protobuf.Empty
	71, // 67: immudb.schema.ImmuService.CurrentState:input_type -> google.protobuf.Empty
	39, // 68: immudb.schema.ImmuService.SetReference:input_type -> immudb.schema.ReferenceRequest
	40, // 69: immudb.schema.ImmuService.VerifiableSetReference:input_type -> immudb.schema.VerifiableReferenceRequest
	41, // 70: immudb.schema.ImmuService.ZAdd:input_type -> immudb.schema.ZAddRequest
	45, // 71: immudb.schema.ImmuService.VerifiableZAdd:input_type -> immudb.schema.VerifiableZAddRequest
	43, // 72: immudb.schema.ImmuService.ZScan:input_type -> immudb.schema.ZScanRequest
	50, // 73: immudb.schema.ImmuService.CreateDatabase:input_type -> immudb.schema.Database
	71, // 74: immudb.schema.ImmuService.DatabaseList:input_type -> google.protobuf.Empty
	50, // 75: immudb.schema.ImmuService.UseDatabase:input_type -> immudb.schema.Database
	71, // 76: immudb.schema.ImmuService.CleanIndex:input_type -> google.protobuf.Empty
	57, // 77: immudb.schema.ImmuService.ChangePermission:input_type -> immudb.schema.ChangePermissionRequest
	58, // 78: immudb.schema.ImmuService.SetActiveUser:input_type -> immudb.schema.SetActiveUserRequest
	33, // 79: immudb.schema.ImmuService.streamGet:input_type -> immudb.schema.KeyRequest
	60, // 80: immudb.schema.ImmuService.streamSet:input_type -> immudb.schema.Chunk
	36, // 81: immudb.schema.ImmuService.streamVerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	60, // 82: immudb.schema.ImmuService.streamVerifiableSet:input_type -> immudb.schema.Chunk
	20, // 83: immudb.schema.ImmuService.streamScan:input_type -> immudb.schema.ScanRequest
	43, // 84: immudb.schema.ImmuService.streamZScan:input_type -> immudb.schema.ZScanRequest
	44, // 85: immudb.schema.ImmuService.streamHistory:input_type -> immudb.schema.HistoryRequest
	60, // 86: immudb.schema.ImmuService.streamExecAll:input_type -> immudb.schema.Chunk
	61, // 87: immudb.schema.ImmuService.UseSnapshot:input_type -> immudb.schema.UseSnapshotRequest
	62, // 88: immudb.schema.ImmuService.SQLExec:input_type -> immudb.schema.SQLExecRequest
	63, // 89: immudb.schema.ImmuService.SQLQuery:input_type -> immudb.schema.SQLQueryRequest
	71, // 90: immudb.schema.ImmuService.ListTables:input_type -> google.protobuf.Empty
	51, // 91: immudb.schema.ImmuService.DescribeTable:input_type -> immudb.schema.Table
	53, // 92: immudb.schema.ImmuService.VerifiableSQLGet:input_type -> immudb.schema.VerifiableSQLGetRequest
	4,  // 93: immudb.schema.ImmuService.ListUsers:output_type -> immudb.schema.UserList
	71, // 94: immudb.schema.ImmuService.CreateUser:output_type -> google.protobuf.Empty
	71, // 95: immudb.schema.ImmuService.ChangePassword:output_type -> google.protobuf.Empty
	71, // 96: immudb.schema.ImmuService.UpdateAuthConfig:output_type -> google.protobuf.Empty
	71, // 97: immudb.schema.ImmuService.UpdateMTLSConfig:output_type -> google.protobuf.Empty
	9,  // 98: immudb.schema.ImmuService.Login:output_type -> immudb.schema.LoginResponse
	71, // 99: immudb.schema.ImmuService.Logout:output_type -> google.protobuf.Empty
	24, // 100: immudb.schema.ImmuService.Set:output_type -> immudb.schema.TxMetadata
	29, // 101: immudb.schema.ImmuService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	13, // 102: immudb.schema.ImmuService.Get:output_type -> immudb.schema.Entry
	30, // 103: immudb.schema.ImmuService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	17, // 104: immudb.schema.ImmuService.GetAll:output_type -> immudb.schema.Entries
	24, // 105: immudb.schema.ImmuService.ExecAll:output_type -> immudb.schema.TxMetadata
	17, // 106: immudb.schema.ImmuService.Scan:output_type -> immudb.schema.Entries
	22, // 107: immudb.schema.ImmuService.Count:output_type -> immudb.schema.EntryCount
	22, // 108: immudb.schema.ImmuService.CountAll:output_type -> immudb.schema.EntryCount
	27, // 109: immudb.schema.ImmuService.TxById:output_type -> immudb.schema.Tx
	29, // 110: immudb.schema.ImmuService.VerifiableTxById:output_type -> immudb.schema.VerifiableTx
	49, // 111: immudb.schema.ImmuService.TxScan:output_type -> immudb.schema.TxList
	17, // 112: immudb.schema.ImmuService.History:output_type -> immudb.schema.Entries
	37, // 113: immudb.schema.ImmuService.Health:output_type -> immudb.schema.HealthResponse
	38, // 114: immudb.schema.ImmuService.CurrentState:output_type -> immudb.schema.ImmutableState
	24, // 115: immudb.schema.ImmuService.SetReference:output_type -> immudb.schema.TxMetadata
	29, // 116: immudb.schema.ImmuService.VerifiableSetReference:output_type -> immudb.schema.VerifiableTx
	24, // 117: immudb.schema.ImmuService.ZAdd:output_type -> immudb.schema.TxMetadata
	29, // 118: immudb.schema.ImmuService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	19, // 119: immudb.schema.ImmuService.ZScan:output_type -> immudb.schema.ZEntries
	71, // 120: immudb.schema.ImmuService.CreateDatabase:output_type -> google.protobuf.Empty
	59, // 121: immudb.schema.ImmuService.DatabaseList:output_type -> immudb.schema.DatabaseListResponse
	56, // 122: immudb.schema.ImmuService.UseDatabase:output_type -> immudb.schema.UseDatabaseReply
	71, // 123: immudb.schema.ImmuService.CleanIndex:output_type -> google.protobuf.Empty
	71, // 124: immudb.schema.ImmuService.ChangePermission:output_type -> google.protobuf.Empty
	71, // 125: immudb.schema.ImmuService.SetActiveUser:output_type -> google.protobuf.Empty
	60, // 126: immudb.schema.ImmuService.streamGet:output_type -> immudb.schema.Chunk
	24, // 127: immudb.schema.ImmuService.streamSet:output_type -> immudb.schema.TxMetadata
	60, // 128: immudb.schema.ImmuService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	29, // 129: immudb.schema.ImmuService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	60, // 130: immudb.schema.ImmuService.streamScan:output_type -> immudb.schema.Chunk
	60, // 131: immudb.schema.ImmuService.streamZScan:output_type -> immudb.schema.Chunk
	60, // 132: immudb.schema.ImmuService.streamHistory:output_type -> immudb.schema.Chunk
	24, // 133: immudb.schema.ImmuService.streamExecAll:output_type -> immudb.schema.TxMetadata
	71, // 134: immudb.schema.ImmuService.UseSnapshot:output_type -> google.protobuf.Empty
	65, // 135: immudb.schema.ImmuService.SQLExec:output_type -> immudb.schema.SQLExecResult
	66, // 136: immudb.schema.ImmuService.SQLQuery:output_type -> immudb.schema.SQLQueryResult
	66, // 137: immudb.schema.ImmuService.ListTables:output_type -> immudb.schema.SQLQueryResult
	66, // 138: immudb.schema.ImmuService.DescribeTable:output_type -> immudb.schema.SQLQueryResult
	55, // 139: immudb.schema.ImmuService.VerifiableSQLGet:output_type -> immudb.schema.VerifiableSQLEntry
