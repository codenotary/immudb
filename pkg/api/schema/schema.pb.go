...
var file_schema_proto_rawDesc = []byte{
	...
	0x52, 0x45, 0x56, 0x4f, 0x4b, 0x45, 0x10, 0x01, 0x32, 0xee, 0x1c, 0x0a, 0x0b, 0x49, 0x6d, 0x6d,
	...
	0x65, 0x72, 0x3a, 0x01, 0x2a, 0x12, 0x40, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x12, 0x19, 0x2e, 0x69, 0x6d, 0x6d, 0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65,
	...
	0x75, 0x6e, 0x6b, 0x22, 0x00, 0x30, 0x01, 0x12, 0x40, 0x0a, 0x09, 0x53, 0x65, 0x74, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x12, 0x14, 0x2e, 0x69, 0x6d, 0x6d, 0x75, 0x64, 0x62, 0x2e, 0x73, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x2e, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x1a, 0x19, 0x2e, 0x69, 0x6d, 0x6d,
	0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x54, 0x78, 0x4d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x00, 0x28, 0x01, 0x42, 0x8b, 0x03, 0x5a, 0x2b, 0x67, 0x69,
...
var file_schema_proto_depIdxs = []int32{
	...
	33, // 63: immudb.schema.ImmuService.GetStream:input_type -> immudb.schema.KeyRequest
	...
	24, // 98: immudb.schema.ImmuService.SetStream:output_type -> immudb.schema.TxMetadata
...
type ImmuServiceClient interface {
	...
	// Streams
	GetStream(ctx context.Context, in *KeyRequest, opts ...grpc.CallOption) (ImmuService_GetStreamClient, error)
...
func (c *immuServiceClient) GetStream(ctx context.Context, in *KeyRequest, opts ...grpc.CallOption) (ImmuService_GetStreamClient, error) {
...
func (x *immuServiceSetStreamClient) CloseAndRecv() (*TxMetadata, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(TxMetadata)
...
type ImmuServiceServer interface {
	...
	// Streams
	GetStream(*KeyRequest, ImmuService_GetStreamServer) error
...
func (*UnimplementedImmuServiceServer) GetStream(*KeyRequest, ImmuService_GetStreamServer) error {
...
func (x *immuServiceSetStreamServer) SendAndClose(m *TxMetadata) error {
	return x.ServerStream.SendMsg(m)
}
