...
var file_schema_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x22, 0xbb, 0x0a, 0x0a, 0x18, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	...
	0x6e, 0x63, 0x46, 0x72, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x44, 0x0a, 0x0b, 0x61,
	0x68, 0x74, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x18, 0x18, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x22, 0x2e, 0x69, 0x6d, 0x6d, 0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x2e, 0x41, 0x48, 0x54, 0x4e, 0x75, 0x6c, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x53, 0x65, 0x74, 0x74,
	0x69, 0x6e, 0x67, 0x73, 0x52, 0x0b, 0x61, 0x68, 0x74, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67,
	0x73, 0x22, 0xb5, 0x03, 0x0a, 0x1b, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	...
	0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x22, 0x5a, 0x0a, 0x13, 0x41, 0x48, 0x54, 0x4e, 0x75,
	...
	0x6f, 0x6c, 0x64, 0x22, 0x31, 0x0a, 0x13, 0x4c, 0x6f, 0x61, 0x64, 0x44, 0x61, 0x74, 0x61, 0x62,
	0x61, 0x73, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x64, 0x61,
	0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x61,
...
var file_schema_proto_depIdxs = []int32{
	...
	81,  // 73: immudb.schema.DatabaseNullableSettings.ahtSettings:type_name -> immudb.schema.AHTNullableSettings
	...
	112, // 94: immudb.schema.SQLGetRequest.pkValues:type_name -> immudb.schema.SQLValue
	91,  // 95: immudb.schema.VerifiableSQLGetRequest.sqlGetRequest:type_name -> immudb.schema.SQLGetRequest
	35,  // 96: immudb.schema.SQLEntry.metadata:type_name -> immudb.schema.KVMetadata
	93,  // 97: immudb.schema.VerifiableSQLEntry.sqlEntry:type_name -> immudb.schema.SQLEntry
	...
	121, // 100: immudb.schema.VerifiableSQLEntry.ColNamesById:type_name -> immudb.schema.VerifiableSQLEntry.ColNamesByIdEntry
	122, // 101: immudb.schema.VerifiableSQLEntry.ColIdsByName:type_name -> immudb.schema.VerifiableSQLEntry.ColIdsByNameEntry
	123, // 102: immudb.schema.VerifiableSQLEntry.ColTypesById:type_name -> immudb.schema.VerifiableSQLEntry.ColTypesByIdEntry
	124, // 103: immudb.schema.VerifiableSQLEntry.ColLenById:type_name -> immudb.schema.VerifiableSQLEntry.ColLenByIdEntry
	...
	101, // 106: immudb.schema.DatabaseListResponseV2.databases:type_name -> immudb.schema.DatabaseWithSettings
	78,  // 107: immudb.schema.DatabaseWithSettings.settings:type_name -> immudb.schema.DatabaseNullableSettings
	106, // 108: immudb.schema.SQLExecRequest.params:type_name -> immudb.schema.NamedParam
	106, // 109: immudb.schema.SQLQueryRequest.params:type_name -> immudb.schema.NamedParam
	112, // 110: immudb.schema.NamedParam.value:type_name -> immudb.schema.SQLValue
	108, // 111: immudb.schema.SQLExecResult.txs:type_name -> immudb.schema.CommittedSQLTx
	29,  // 112: immudb.schema.CommittedSQLTx.header:type_name -> immudb.schema.TxHeader
	125, // 113: immudb.schema.CommittedSQLTx.lastInsertedPKs:type_name -> immudb.schema.CommittedSQLTx.LastInsertedPKsEntry
	126, // 114: immudb.schema.CommittedSQLTx.firstInsertedPKs:type_name -> immudb.schema.CommittedSQLTx.FirstInsertedPKsEntry
	110, // 115: immudb.schema.SQLQueryResult.columns:type_name -> immudb.schema.Column
	111, // 116: immudb.schema.SQLQueryResult.rows:type_name -> immudb.schema.Row
	112, // 117: immudb.schema.Row.values:type_name -> immudb.schema.SQLValue
	127, // 118: immudb.schema.SQLValue.null:type_name -> google.protobuf.NullValue
	2,   // 119: immudb.schema.NewTxRequest.mode:type_name -> immudb.schema.TxMode
	112, // 120: immudb.schema.CommittedSQLTx.LastInsertedPKsEntry.value:type_name -> immudb.schema.SQLValue
	112, // 121: immudb.schema.CommittedSQLTx.FirstInsertedPKsEntry.value:type_name -> immudb.schema.SQLValue
	128, // 122: immudb.schema.ImmuService.ListUsers:input_type -> google.protobuf.Empty
	...
	96,  // 125: immudb.schema.ImmuService.ChangePermission:input_type -> immudb.schema.ChangePermissionRequest
	97,  // 126: immudb.schema.ImmuService.SetActiveUser:input_type -> immudb.schema.SetActiveUserRequest
	...
	128, // 130: immudb.schema.ImmuService.CloseSession:input_type -> google.protobuf.Empty
	128, // 131: immudb.schema.ImmuService.KeepAlive:input_type -> google.protobuf.Empty
	113, // 132: immudb.schema.ImmuService.NewTx:input_type -> immudb.schema.NewTxRequest
	128, // 133: immudb.schema.ImmuService.Commit:input_type -> google.protobuf.Empty
	128, // 134: immudb.schema.ImmuService.Rollback:input_type -> google.protobuf.Empty
	104, // 135: immudb.schema.ImmuService.TxSQLExec:input_type -> immudb.schema.SQLExecRequest
	105, // 136: immudb.schema.ImmuService.TxSQLQuery:input_type -> immudb.schema.SQLQueryRequest
	10,  // 137: immudb.schema.ImmuService.Login:input_type -> immudb.schema.LoginRequest
	128, // 138: immudb.schema.ImmuService.Logout:input_type -> google.protobuf.Empty
	...
	128, // 148: immudb.schema.ImmuService.CountAll:input_type -> google.protobuf.Empty
	...
	128, // 154: immudb.schema.ImmuService.Health:input_type -> google.protobuf.Empty
	128, // 155: immudb.schema.ImmuService.DatabaseHealth:input_type -> google.protobuf.Empty
	128, // 156: immudb.schema.ImmuService.CurrentState:input_type -> google.protobuf.Empty
	...
	82,  // 165: immudb.schema.ImmuService.LoadDatabase:input_type -> immudb.schema.LoadDatabaseRequest
	84,  // 166: immudb.schema.ImmuService.UnloadDatabase:input_type -> immudb.schema.UnloadDatabaseRequest
	86,  // 167: immudb.schema.ImmuService.DeleteDatabase:input_type -> immudb.schema.DeleteDatabaseRequest
	128, // 168: immudb.schema.ImmuService.DatabaseList:input_type -> google.protobuf.Empty
	99,  // 169: immudb.schema.ImmuService.DatabaseListV2:input_type -> immudb.schema.DatabaseListRequestV2
	...
	128, // 173: immudb.schema.ImmuService.GetDatabaseSettings:input_type -> google.protobuf.Empty
	71,  // 174: immudb.schema.ImmuService.GetDatabaseSettingsV2:input_type -> immudb.schema.DatabaseSettingsRequest
	88,  // 175: immudb.schema.ImmuService.FlushIndex:input_type -> immudb.schema.FlushIndexRequest
	128, // 176: immudb.schema.ImmuService.CompactIndex:input_type -> google.protobuf.Empty
	41,  // 177: immudb.schema.ImmuService.streamGet:input_type -> immudb.schema.KeyRequest
	102, // 178: immudb.schema.ImmuService.streamSet:input_type -> immudb.schema.Chunk
	45,  // 179: immudb.schema.ImmuService.streamVerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	102, // 180: immudb.schema.ImmuService.streamVerifiableSet:input_type -> immudb.schema.Chunk
	...
	102, // 184: immudb.schema.ImmuService.streamExecAll:input_type -> immudb.schema.Chunk
	64,  // 185: immudb.schema.ImmuService.exportTx:input_type -> immudb.schema.ExportTxRequest
	102, // 186: immudb.schema.ImmuService.replicateTx:input_type -> immudb.schema.Chunk
	104, // 187: immudb.schema.ImmuService.SQLExec:input_type -> immudb.schema.SQLExecRequest
	105, // 188: immudb.schema.ImmuService.SQLQuery:input_type -> immudb.schema.SQLQueryRequest
	128, // 189: immudb.schema.ImmuService.ListTables:input_type -> google.protobuf.Empty
	90,  // 190: immudb.schema.ImmuService.DescribeTable:input_type -> immudb.schema.Table
	92,  // 191: immudb.schema.ImmuService.VerifiableSQLGet:input_type -> immudb.schema.VerifiableSQLGetRequest
	6,   // 192: immudb.schema.ImmuService.ListUsers:output_type -> immudb.schema.UserList
	128, // 193: immudb.schema.ImmuService.CreateUser:output_type -> google.protobuf.Empty
	128, // 194: immudb.schema.ImmuService.ChangePassword:output_type -> google.protobuf.Empty
	128, // 195: immudb.schema.ImmuService.ChangePermission:output_type -> google.protobuf.Empty
	128, // 196: immudb.schema.ImmuService.SetActiveUser:output_type -> google.protobuf.Empty
	128, // 197: immudb.schema.ImmuService.UpdateAuthConfig:output_type -> google.protobuf.Empty
	128, // 198: immudb.schema.ImmuService.UpdateMTLSConfig:output_type -> google.protobuf.Empty
	15,  // 199: immudb.schema.ImmuService.OpenSession:output_type -> immudb.schema.OpenSessionResponse
	128, // 200: immudb.schema.ImmuService.CloseSession:output_type -> google.protobuf.Empty
	128, // 201: immudb.schema.ImmuService.KeepAlive:output_type -> google.protobuf.Empty
	114, // 202: immudb.schema.ImmuService.NewTx:output_type -> immudb.schema.NewTxResponse
	108, // 203: immudb.schema.ImmuService.Commit:output_type -> immudb.schema.CommittedSQLTx
	128, // 204: immudb.schema.ImmuService.Rollback:output_type -> google.protobuf.Empty
	128, // 205: immudb.schema.ImmuService.TxSQLExec:output_type -> google.protobuf.Empty
	109, // 206: immudb.schema.ImmuService.TxSQLQuery:output_type -> immudb.schema.SQLQueryResult
	11,  // 207: immudb.schema.ImmuService.Login:output_type -> immudb.schema.LoginResponse
	128, // 208: immudb.schema.ImmuService.Logout:output_type -> google.protobuf.Empty
	...
	128, // 232: immudb.schema.ImmuService.CreateDatabase:output_type -> google.protobuf.Empty
	128, // 233: immudb.schema.ImmuService.CreateDatabaseWith:output_type -> google.protobuf.Empty
	68,  // 234: immudb.schema.ImmuService.CreateDatabaseV2:output_type -> immudb.schema.CreateDatabaseResponse
	83,  // 235: immudb.schema.ImmuService.LoadDatabase:output_type -> immudb.schema.LoadDatabaseResponse
	85,  // 236: immudb.schema.ImmuService.UnloadDatabase:output_type -> immudb.schema.UnloadDatabaseResponse
	87,  // 237: immudb.schema.ImmuService.DeleteDatabase:output_type -> immudb.schema.DeleteDatabaseResponse
	98,  // 238: immudb.schema.ImmuService.DatabaseList:output_type -> immudb.schema.DatabaseListResponse
	100, // 239: immudb.schema.ImmuService.DatabaseListV2:output_type -> immudb.schema.DatabaseListResponseV2
	95,  // 240: immudb.schema.ImmuService.UseDatabase:output_type -> immudb.schema.UseDatabaseReply
	128, // 241: immudb.schema.ImmuService.UpdateDatabase:output_type -> google.protobuf.Empty
	...
	89,  // 245: immudb.schema.ImmuService.FlushIndex:output_type -> immudb.schema.FlushIndexResponse
	128, // 246: immudb.schema.ImmuService.CompactIndex:output_type -> google.protobuf.Empty
	102, // 247: immudb.schema.ImmuService.streamGet:output_type -> immudb.schema.Chunk
	29,  // 248: immudb.schema.ImmuService.streamSet:output_type -> immudb.schema.TxHeader
	102, // 249: immudb.schema.ImmuService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	37,  // 250: immudb.schema.ImmuService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	102, // 251: immudb.schema.ImmuService.streamScan:output_type -> immudb.schema.Chunk
	102, // 252: immudb.schema.ImmuService.streamZScan:output_type -> immudb.schema.Chunk
	102, // 253: immudb.schema.ImmuService.streamHistory:output_type -> immudb.schema.Chunk
	29,  // 254: immudb.schema.ImmuService.streamExecAll:output_type -> immudb.schema.TxHeader
	102, // 255: immudb.schema.ImmuService.exportTx:output_type -> immudb.schema.Chunk
	29,  // 256: immudb.schema.ImmuService.replicateTx:output_type -> immudb.schema.TxHeader
	107, // 257: immudb.schema.ImmuService.SQLExec:output_type -> immudb.schema.SQLExecResult
	109, // 258: immudb.schema.ImmuService.SQLQuery:output_type -> immudb.schema.SQLQueryResult
	109, // 259: immudb.schema.ImmuService.ListTables:output_type -> immudb.schema.SQLQueryResult
	109, // 260: immudb.schema.ImmuService.DescribeTable:output_type -> immudb.schema.SQLQueryResult
	94,  // 261: immudb.schema.ImmuService.VerifiableSQLGet:output_type -> immudb.schema.VerifiableSQLEntry
