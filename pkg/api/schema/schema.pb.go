...
var file_schema_proto_rawDesc = []byte{
	...
	0x06, 0x52, 0x45, 0x56, 0x4f, 0x4b, 0x45, 0x10, 0x01, 0x32, 0xa4, 0x24, 0x0a, 0x0b, 0x49, 0x6d,
	...
	0x6c, 0x65, 0x61, 0x6e, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x58, 0x0a, 0x0c, 0x43, 0x6f, 0x6d,
	...
	0x2e, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x22, 0x00, 0x30, 0x01, 0x12, 0x40, 0x0a, 0x09, 0x73, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x74, 0x12, 0x14, 0x2e, 0x69, 0x6d, 0x6d, 0x75, 0x64, 0x62,
	0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x1a, 0x19, 0x2e,
	0x69, 0x6d, 0x6d, 0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x54, 0x78,
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x00, 0x28, 0x01, 0x12, 0x54, 0x0a, 0x13,
	...
	0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x43, 0x68, 0x75, 0x6e, 0x6b,
	0x22, 0x00, 0x30, 0x01, 0x12, 0x44, 0x0a, 0x0d, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x45, 0x78,
	...
	0x6d, 0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x54, 0x78, 0x4d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x00, 0x28, 0x01, 0x12, 0x3e, 0x0a, 0x08, 0x65, 0x78,
	...
	0x1a, 0x14, 0x2e, 0x69, 0x6d, 0x6d, 0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x2e, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x22, 0x00, 0x30, 0x01, 0x12, 0x42, 0x0a, 0x0b, 0x72, 0x65,
	...
	0x54, 0x78, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x00, 0x28, 0x01, 0x12, 0x61,
	0x0a, 0x0b, 0x55, 0x73, 0x65, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x12, 0x21, 0x2e,
	...
	0x12, 0x0f, 0x2f, 0x64, 0x62, 0x2f, 0x75, 0x73, 0x65, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f,
	0x74, 0x12, 0x5e, 0x0a, 0x07, 0x53, 0x51, 0x4c, 0x45, 0x78, 0x65, 0x63, 0x12, 0x1d, 0x2e, 0x69,
...
var file_schema_proto_depIdxs = []int32{
	...
	78,  // 81: immudb.schema.ImmuService.CompactIndex:input_type -> google.protobuf.Empty
	58,  // 82: immudb.schema.ImmuService.ChangePermission:input_type -> immudb.schema.ChangePermissionRequest
	59,  // 83: immudb.schema.ImmuService.SetActiveUser:input_type -> immudb.schema.SetActiveUserRequest
	33,  // 84: immudb.schema.ImmuService.streamGet:input_type -> immudb.schema.KeyRequest
	61,  // 85: immudb.schema.ImmuService.streamSet:input_type -> immudb.schema.Chunk
	36,  // 86: immudb.schema.ImmuService.streamVerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	61,  // 87: immudb.schema.ImmuService.streamVerifiableSet:input_type -> immudb.schema.Chunk
	20,  // 88: immudb.schema.ImmuService.streamScan:input_type -> immudb.schema.ScanRequest
	43,  // 89: immudb.schema.ImmuService.streamZScan:input_type -> immudb.schema.ZScanRequest
	44,  // 90: immudb.schema.ImmuService.streamHistory:input_type -> immudb.schema.HistoryRequest
	61,  // 91: immudb.schema.ImmuService.streamExecAll:input_type -> immudb.schema.Chunk
	46,  // 92: immudb.schema.ImmuService.exportTx:input_type -> immudb.schema.TxRequest
	61,  // 93: immudb.schema.ImmuService.replicateTx:input_type -> immudb.schema.Chunk
	62,  // 94: immudb.schema.ImmuService.UseSnapshot:input_type -> immudb.schema.UseSnapshotRequest
	63,  // 95: immudb.schema.ImmuService.SQLExec:input_type -> immudb.schema.SQLExecRequest
	64,  // 96: immudb.schema.ImmuService.SQLQuery:input_type -> immudb.schema.SQLQueryRequest
	78,  // 97: immudb.schema.ImmuService.ListTables:input_type -> google.protobuf.Empty
	52,  // 98: immudb.schema.ImmuService.DescribeTable:input_type -> immudb.schema.Table
	54,  // 99: immudb.schema.ImmuService.VerifiableSQLGet:input_type -> immudb.schema.VerifiableSQLGetRequest
	4,   // 100: immudb.schema.ImmuService.ListUsers:output_type -> immudb.schema.UserList
	78,  // 101: immudb.schema.ImmuService.CreateUser:output_type -> google.protobuf.Empty
	78,  // 102: immudb.schema.ImmuService.ChangePassword:output_type -> google.protobuf.Empty
	78,  // 103: immudb.schema.ImmuService.UpdateAuthConfig:output_type -> google.protobuf.Empty
	78,  // 104: immudb.schema.ImmuService.UpdateMTLSConfig:output_type -> google.protobuf.Empty
	9,   // 105: immudb.schema.ImmuService.Login:output_type -> immudb.schema.LoginResponse
	78,  // 106: immudb.schema.ImmuService.Logout:output_type -> google.protobuf.Empty
	24,  // 107: immudb.schema.ImmuService.Set:output_type -> immudb.schema.TxMetadata
	29,  // 108: immudb.schema.ImmuService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	13,  // 109: immudb.schema.ImmuService.Get:output_type -> immudb.schema.Entry
	30,  // 110: immudb.schema.ImmuService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	17,  // 111: immudb.schema.ImmuService.GetAll:output_type -> immudb.schema.Entries
	24,  // 112: immudb.schema.ImmuService.ExecAll:output_type -> immudb.schema.TxMetadata
	17,  // 113: immudb.schema.ImmuService.Scan:output_type -> immudb.schema.Entries
	22,  // 114: immudb.schema.ImmuService.Count:output_type -> immudb.schema.EntryCount
	22,  // 115: immudb.schema.ImmuService.CountAll:output_type -> immudb.schema.EntryCount
	27,  // 116: immudb.schema.ImmuService.TxById:output_type -> immudb.schema.Tx
	29,  // 117: immudb.schema.ImmuService.VerifiableTxById:output_type -> immudb.schema.VerifiableTx
	49,  // 118: immudb.schema.ImmuService.TxScan:output_type -> immudb.schema.TxList
	17,  // 119: immudb.schema.ImmuService.History:output_type -> immudb.schema.Entries
	37,  // 120: immudb.schema.ImmuService.Health:output_type -> immudb.schema.HealthResponse
	38,  // 121: immudb.schema.ImmuService.CurrentState:output_type -> immudb.schema.ImmutableState
	24,  // 122: immudb.schema.ImmuService.SetReference:output_type -> immudb.schema.TxMetadata
	29,  // 123: immudb.schema.ImmuService.VerifiableSetReference:output_type -> immudb.schema.VerifiableTx
	24,  // 124: immudb.schema.ImmuService.ZAdd:output_type -> immudb.schema.TxMetadata
	29,  // 125: immudb.schema.ImmuService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	19,  // 126: immudb.schema.ImmuService.ZScan:output_type -> immudb.schema.ZEntries
	78,  // 127: immudb.schema.ImmuService.CreateDatabase:output_type -> google.protobuf.Empty
	60,  // 128: immudb.schema.ImmuService.DatabaseList:output_type -> immudb.schema.DatabaseListResponse
	57,  // 129: immudb.schema.ImmuService.UseDatabase:output_type -> immudb.schema.UseDatabaseReply
	78,  // 130: immudb.schema.ImmuService.UpdateDatabase:output_type -> google.protobuf.Empty
	78,  // 131: immudb.schema.ImmuService.CleanIndex:output_type -> google.protobuf.Empty
	78,  // 132: immudb.schema.ImmuService.CompactIndex:output_type -> google.protobuf.Empty
	78,  // 133: immudb.schema.ImmuService.ChangePermission:output_type -> google.protobuf.Empty
	78,  // 134: immudb.schema.ImmuService.SetActiveUser:output_type -> google.protobuf.Empty
	61,  // 135: immudb.schema.ImmuService.streamGet:output_type -> immudb.schema.Chunk
	24,  // 136: immudb.schema.ImmuService.streamSet:output_type -> immudb.schema.TxMetadata
	61,  // 137: immudb.schema.ImmuService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	29,  // 138: immudb.schema.ImmuService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	61,  // 139: immudb.schema.ImmuService.streamScan:output_type -> immudb.schema.Chunk
	61,  // 140: immudb.schema.ImmuService.streamZScan:output_type -> immudb.schema.Chunk
	61,  // 141: immudb.schema.ImmuService.streamHistory:output_type -> immudb.schema.Chunk
	24,  // 142: immudb.schema.ImmuService.streamExecAll:output_type -> immudb.schema.TxMetadata
	61,  // 143: immudb.schema.ImmuService.exportTx:output_type -> immudb.schema.Chunk
	24,  // 144: immudb.schema.ImmuService.replicateTx:output_type -> immudb.schema.TxMetadata
	78,  // 145: immudb.schema.ImmuService.UseSnapshot:output_type -> google.protobuf.Empty
	66,  // 146: immudb.schema.ImmuService.SQLExec:output_type -> immudb.schema.SQLExecResult
	67,  // 147: immudb.schema.ImmuService.SQLQuery:output_type -> immudb.schema.SQLQueryResult
	67,  // 148: immudb.schema.ImmuService.ListTables:output_type -> immudb.schema.SQLQueryResult
	67,  // 149: immudb.schema.ImmuService.DescribeTable:output_type -> immudb.schema.SQLQueryResult
	56,  // 150: immudb.schema.ImmuService.VerifiableSQLGet:output_type -> immudb.schema.VerifiableSQLEntry
